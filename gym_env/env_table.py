...
class ModularDRLTableEnv(gym.Env):
    ...
    def compute_reward(self, achieved_goal, desired_goal, info):
        ...
        reward, _, _, _, _ = self.goals[0].reward(self.steps_current_episode, self.robots[0].)
        # restore variables
    ...
    def reset(self):
        ...
        while True:
            ...
            while True:
                ...
                starting_states = self.world.create_starting_states()
                self.world.setup_starting_states()
