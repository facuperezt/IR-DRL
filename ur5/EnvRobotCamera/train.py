...
if __name__=='__main__':
    ...
    model = PPO("MultiInputPolicy", env, gamma=0.999, policy_kwargs= policy_kwargs, batch_size=512, verbose=1, tensorboard_log=f'./models/reach_ppo_tf_logs/{params["camera_args"]["type"]}/{args.name}')
